...
Melanie Weilert
June 2021
Purpose: Given a set of motifs and corresponding sequences/predictions, generate in silico genomic perturbations from 1-channel data.
                ...
                if use_whole_window:
                    ...
                    for idx,motif in motif_set.iterrows():
                        ...
                        if lower_bounds<=0 or upper_bounds>=bpnet_model.input_seqlen():
                            ...
                            pred_max = sig_bounded[max_sig_idx,[0]].sum()
