...
def bpnet_train_as_grid_search(dataspec,
    ...
    cmds = [f"bpnet train --num-workers 8 --vmtouch --config={config} --override='{i[0]}' --run-id {i[1]} --memfrac-gpu {memfrac_gpu} {dataspec} {output_directory}" for i in zip(hps, hp_names)]
